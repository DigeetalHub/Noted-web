...
const DownloadNow = ({ classes }) => {
	return (
		<section className="mt-[2.5rem] px-2 md:px-0 md:mt-[5.5rem]">
			<div
				className={`px-4 py-[2.5rem] bg-download flex flex-col gap-6 text-white text-center rounded md:w-[80%] md:mx-auto md:rounded-2xl md:pt-[3rem] md:pb-[4rem] md:gap-[2.2rem] lg:w-[82%] lg:pt-[3.5rem] lg:pb-[6rem] lg:gap-[3.8rem] bigScreen:w-[65%] bigScreen:gap-[2.5rem] ${classes}`}
			>
