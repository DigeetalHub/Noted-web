...
const ContactOverlay = () => {
  return (
      <div className='w-full bg-brandPrimary500 bg-opacity-[0.2] absolute z-[1] top-[12rem] left-0 py-[4.5rem] pl-[3rem]'>
          <div className="flex flex-col gap-[5rem]">
              <ContactContent icon={Call} text="(123) 456-7890" heading="Call us" />
