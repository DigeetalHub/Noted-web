...
const Footer = ({ className }) => {
	...
	return (
		<footer className={`${className} py-6 px-4 md:pt-[4rem]  bg-brandPrimary900`}>
			<div className="flex flex-col flex-wrap gap-[1.7rem] fold:gap-[2.5rem] text-center text-white dualFold:flex-row dualFold:justify-between dualFold:text-left dualFold:w-[90%] dualFold:mx-auto dualFold:gap-y-[1rem] lg:w-[80%] bigScreen:w-[70%] fold:text-sm s22:text-base">
				...
				<div className="flex flex-col gap-3">
					...
					>
						<Image
							src={Email}
							alt="Email icon"
							className="inline-block w-[12px] fold:w-auto"
						/>{' '}
				...
				<div className="flex flex-col gap-3 dualFold:flex-row items-center md:mt-[2rem] xl:w-[40%]">
				...
				<div className="border-t-[1px] border-t-white pt-5 w-full space-y-4">
					<p className="flex items-center font-semibold justify-center text-[0.55rem] fold:text-sm s22:text-base">
						<Image
							src={Copyright}
							alt="Copyright icon"
							className="mr-[5px] fold:mr-2 w-[10px] fold:w-[15px]"
						/>{' '}
					...
					<p className="text-center font-medium">
						...
						<Link
							href="https://www.digeetalhub.com"
							target="_blank"
