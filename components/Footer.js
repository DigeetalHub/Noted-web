...
const Footer = ({className}) => {
	...
	return (
		<footer className={`${className} py-6 px-4 fold:pt-[3rem] bg-brandPrimary900 mt-[3rem] fold:mt-[5.5rem] md:pt-[3rem]`}>
			<div className="flex flex-col flex-wrap gap-[1.7rem] fold:gap-[2.5rem] text-center text-white dualFold:flex-row dualFold:justify-between dualFold:text-left dualFold:w-[90%] dualFold:mx-auto dualFold:gap-y-[4rem] lg:w-[80%] bigScreen:w-[70%]">
				...
				<div className="flex flex-col gap-3">
					...
					>
						...
						<span className="ml-[0.5rem] fold:ml-[0.4rem] border-b-[2px] border-b-brandPrimary500">getnoted@notedmediagroup.com</span>
					</Link>
				</div>
				...
				<div className="border-t-[1px] border-t-white pt-5 w-full space-y-4">
					<p className="flex items-center font-semibold justify-center text-[0.55rem] fold:text-sm s22:text-base">
						...
						{year} |&nbsp;<span className="hidden md:block">All rights reserved. Noted</span><span className="md:hidden">Noted</span>
					</p>
					<p className="text-center font-medium">Designed and Developed by <Link href="https://www.digeetalhub.com" target="_blank" className="underline underline-offset-4">DigeetalHub</Link></p>
				</div>
			</div>
		</footer>
	);
